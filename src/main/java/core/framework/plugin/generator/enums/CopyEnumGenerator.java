...
public class CopyEnumGenerator extends AnAction {
    ...
    public static final String ENUM_TEMPLATE = "import core.framework.api.json.Property;\n" +
        "\n" +
        "public enum %1$s {\n";
    public static final String ENUM_TEMPLATE_V2 = """
    ...
    public static final String TEST_CLASS_TEMPLATE_V2 = """
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        StringBuilder sb = new StringBuilder(String.format(ENUM_TEMPLATE_V2, generateEnumName, userName));
            ...
            if (testDirVF != null) {
                ...
                if (enumTestVF == null) {
                    PsiFile testClassFile = PsiFileFactory.getInstance(project).createFileFromText(JavaLanguage.INSTANCE,
                        String.format(TEST_CLASS_TEMPLATE_V2, methodName, fullGenerateEnumName, fullSelectEnumName, userName));
