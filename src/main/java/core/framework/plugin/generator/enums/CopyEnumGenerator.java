...
public class CopyEnumGenerator extends AnAction {
    ...
    public static final String ENUM_TEMPLATE_V2 = """
        ...
        /**
         * This enum is generated by the plugin. Please review the enum definition and unit tests.
         */
        public enum %1$s {
        """;
    ...
    public static final String TEST_CLASS_TEMPLATE_V2 = """
        ...
        /**
         * This unit test is generated by the plugin. Please review.
         */
        class EnumTest {
            @Test
            void test%1$s() {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        StringBuilder sb = new StringBuilder(String.format(ENUM_TEMPLATE_V2, generateEnumName));
            ...
            if (testDirVF != null) {
                ...
                if (enumTestVF == null) {
                    PsiFile testClassFile = PsiFileFactory.getInstance(project).createFileFromText(JavaLanguage.INSTANCE,
                        String.format(TEST_CLASS_TEMPLATE_V2, methodName, fullGenerateEnumName, fullSelectEnumName));
